...
public class aiSystem {
    ...
    public void state_machine(int ballX,int ballY,int goalX,int goalY,Mat rgbaImage,double [] obstacles){
        ...
        if(ballX == 0 && ballY == 0 && obstacles[1] == 0 && obstacles[2] == 0){
            ball_reached = 0;
            ...
            store_wheel_velocities(100.0,0.0);
            state = 0; //for debug
            dribble = 0;
        }
        ...
        if(ballX > 0 && ballY > 0 && obstacles[1] == 0 && obstacles[2] == 0) {
            ...
            goal_rad = Math.atan2(ballY - robot_y, ballX - robot_x);
            goal_angle = containAngle360(Math.toDegrees(goal_rad)); //limit angle between 0 and 360 degrees
            goalAngle = get_heading(goal_angle, obstacles);
        ...
        if(ballX < 100 && ballX > 0 && obstacles[1] == 0 && obstacles[2] == 0 && goalX == 0 && goalY == 0){
            ball_reached = 1;
        ...
        if(ballX < 100 && ballX > 0 && goalX == 0 && goalY == 0 && obstacles[1] > 0 && obstacles[2] > 0){
            ball_reached = 1;
            goal_rad = Math.atan2(goalY - robot_y, goalX - robot_x);
            goal_angle = containAngle360(Math.toDegrees(goal_rad)); //limit angle between 0 and 360 degrees
            store_wheel_velocities(0.0,0.0);
