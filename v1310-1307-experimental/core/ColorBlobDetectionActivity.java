...
//                            Toast.makeText(getBaseContext(), "setting up serial", Toast.LENGTH_SHORT).show();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //startButton.startAnimation(AnimationUtils.loadAnimation(this, R.anim.rotation) );
...
//        Toast.makeText(ColorBlobDetectionActivity.this,"Sent string to arduino", Toast.LENGTH_LONG).show();
        ...
        int [] motorVels = mAIsystem.find_wheel_velocities(ballX,ballY,GoalX,GoalY,mRgba,obstacles); //call the AI system here and give it values from the VISION with each frame
        String motA = Integer.toString(motorVels[0]);
        String motB = Integer.toString(motorVels[1]);
        String kick = Integer.toString(mAIsystem.kick_ball());
...
//        }
    ...
    public void onClickSend2(View view) {
        Toast.makeText(getBaseContext(), "Switching to goal", Toast.LENGTH_SHORT).show();
        ball_ai_reached = 1;
    }
