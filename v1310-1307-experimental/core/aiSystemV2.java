...
public class aiSystemV2 {
    ...
    //WHEEL VELOCITIES
    public int[] find_wheel_velocities(int ballX,int ballY,int,int goalX,int goalY,int wallX, int wallY,Mat rgbaImage,double [] obstacles){
