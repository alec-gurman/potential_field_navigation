...
//                            Toast.makeText(getBaseContext(), "setting up serial", Toast.LENGTH_SHORT).show();
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        double goalArea = mDetector.goal_area();
        ...
        if(stop == 0) {
            ...
            if (ball_found) {
                mAIsystem.state_machine(ballX,ballY,goalX,goalY,goalArea,mRgba,obstacles);
            }
    ...
    public void onClickSend2(View view) {
        ...
        stop = 0;
        ball_found = false;
        mAIsystem.reset_state_8();
        mAIsystem.reset_ball_reached();
