...
//                String steveo = String.format(Locale.ENGLISH, "Device ID: %d", device);
//                Toast.makeText(getBaseContext(), steveo, Toast.LENGTH_SHORT).show();
                ...
                if (deviceVID == 0x1A86 || deviceVID == 0x2341 || deviceVID == 6790)//Arduino Vendor ID
                {
                    ...
                    Toast.makeText(getBaseContext(), "Not an Arduino!", Toast.LENGTH_SHORT).show();
                    connection = null;
                    device = null;
                }
