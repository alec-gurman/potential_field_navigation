...
//        Toast.makeText(ColorBlobDetectionActivity.this,"Sent string to arduino", Toast.LENGTH_LONG).show();
        ...
        mAIsystem.find_wheel_velocities(ballX,ballY,mRgba,obstacles); //call the AI system here and give it values from the VISION with each frame
//        sendMotorVel(motA,motB,kick);
...
//                String steve = String.format(Locale.ENGLISH, "VID: %d", deviceVID);
...
//    public void sendMotorVel(String motA,String motB,String kick){
//        String send = motA + "," + motB + "," + kick;
//        if(serialPort != null) {
//            serialPort.write(send.getBytes());
//        }
//        else {
